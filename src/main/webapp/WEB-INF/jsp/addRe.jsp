...
<a onclick="self.location=document.referrer"  class="layui-btn">返回帖子</a>
</div>
    ...
    <div class="layui-form layui-form-pane">
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        <ul class="layui-tab-title">
          <li class="layui-this">回复<!-- 编辑帖子 --></li>
        </ul>
        <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
          <div class="layui-tab-item layui-show">
            <form action="/bbs/post/addRe" method="post" enctype="multipart/form-data">
              <div class="layui-row layui-col-space15 layui-form-item">
                ...
                <div class="layui-col-md9">
                  ...
                  <div class="layui-input-block"> <label class="layui-form-label"><a href="/bbs/post/${post.pid}">${post.title}</a></label>

                    <input type="hidden" name="pid" value="${post.pid}">
                   <!-- <input type="text" id="L_title" value required lay-verify="required" autocomplete="off" class="layui-input" maxlength="40">-->
...
<c:if test="${empty rere}">
              <div class="layui-form-item layui-form-text">

                <div class="layui-input-block">
                  <label class="layui-form-label">文本域</label>
                  <textarea id="text"  name="content" required lay-verify="required"  placeholder="详细描述,不超过850字" class="layui-textarea fly-editor" style="height: 260px;" maxlength="850">${r.content}</textarea>
              ...
              <c:if test="${not empty rere}">
                ...
                <br>
                  <div class="layui-input-block">
                    <label class="layui-form-label">文本域</label>
                    <textarea id="text1"  name="content" required lay-verify="required"  placeholder="详细描述,不超过850字" class="layui-textarea fly-editor" style="height: 260px;" maxlength="850"></textarea>
                    <input type="hidden" name="rerid" value="${r.rid}">
                  </div>
                </div>
